...
const dictionaries: Dictionaries = {
  en: {
    utils: {
      website: 'Website',
      sources: 'Source code',
      version: 'Version {{templateContent}}',
    },
    homepage: {
      ...
      documentation: 'You don\'t know how how to recover your data archives ?',
      documentationLink: 'Check out our documentation',
    },
    history: {
      delete: 'Delete',
      restore: 'Restore',
      reset: 'Reset history',
      openFolder: 'Open History Folder',
      empty: 'No archive has been processed',
      restored: 'Archive "{{templateContent}}" restored',
    },
    settings: {
      title: 'Settings',
      theme: 'Theme',
  ...
  fr: {
    ...
    homepage: {
      ...
      documentation: 'Vous ne savez pas comment récupérer vos archives ?',
      documentationLink: 'Consultez notre documentation',
    },
    history: {
      delete: 'Supprimer',
      restore: 'Restaurer',
      reset: 'Supprimer l\'historique',
      openFolder: 'Ouvrir le dossier d\'historique',
      empty: 'Aucune archive n\'a été traitée',
      restored: 'Archive "{{templateContent}}" restaurée',
    },
    settings: {
      title: 'Réglages',
      theme: 'Thème',
...
export default function Trans<P extends keyof Dictionary, K extends keyof Dictionary[P]>(
  { page, section, template = '{{template}}', templateContent = '' }: {
    page: P, section: K, template?: string, templateContent?: any
  },
): JSX.Element {
